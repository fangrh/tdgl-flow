...
This project is indexed by GitNexus as **tdgl-flow** (695 symbols, 1102 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
